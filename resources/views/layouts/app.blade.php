...
<body class="bg-gray-50 font-family-karla">
    ...
    <nav class="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
        ...
        <div :class="open ? 'block' : 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div
                class="w-full container mx-auto md:w-2/3 flex flex-col sm:flex-row items-center justify-between text-sm font-bold uppercase mt-0 py-2">
                <div>
                    <a href="{{ route('home') }}"
                    ...
                    @auth
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button
                                        class="hover:bg-blue-600 hover:text-white rounded py-2 flex items-center px-4 mx-2">
    ...
    <div class="container justify-center mx-auto py-6">
        <div class="p-3">
            <form method="get" action="{{ route('search') }}">
                <input name="q" value="{{ request()->get('q') }}"
